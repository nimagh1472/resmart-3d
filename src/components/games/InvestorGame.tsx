...
import { Award, Gauge, LineChart, Play, RotateCcw, Truck, Users } from 'lucide-react';
...
export function InvestorGame() {
  ...
  return (
    <div className="pointer-events-none absolute inset-y-0 left-4 z-[25] flex items-center">
      <div className="pointer-events-auto w-80 max-h-[85vh] overflow-y-auto rounded-3xl border border-white/15 bg-white/10 p-5 shadow-2xl shadow-cyan-500/10 backdrop-blur-2xl">
